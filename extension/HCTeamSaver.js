...
if (window.location.href.includes("index.php?page=units")) {
    (function(){
        ...
        tmp.onclick = function(e){
            ...
            var file = elem.outerHTML + "<style>img.inlineimg {display: none;}.units_link:hover {cursor: pointer;}</style><script>function showFigure(str) {let url = 'https://www.hcrealms.com/forum/units/units_figure.php?q=';url += str;window.open(url, '_blank');}</script>";
